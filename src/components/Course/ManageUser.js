...
const ManageUser = (props) => {
  ...
  useEffect(() => {
    ...
    axios.get(SERVER_ADDRESS+'get-roles', 
    { headers: {
  ...
  const rolesToDisplay = roles.map((role) =>{
    ...
    return (
      <option key={role.id+role.roleName} value={role.id} selected={(role.id===userRole)?true:false}>
        {role.roleName}
      </option>
    )
  });
            ...
            <Form>
              <Row>
                <Col sm={4}>
                  <Form.Group className="required">
                    ...
                    <Form.Control required type="text" id="userFirstName" onChange={onUserNameChangeHandler} value={userFirstName}/>
                ...
                <Col sm={4}>
                  <Form.Group key="topicNameInputGroup" className="required">
                    ...
                    <Form.Control required type="text" id="userLastName" onChange={onUserLastNameChangeHandler} value={userLastName}/>
                ...
                <Col sm={4}>
                  <Form.Group className="required">
                    ...
                    <Form.Control required type="email" placeholder="Enter email" onChange={onUserEmailChangeHandler} value={userEmail}/>
              ...
              <Col sm={4}>
                  <Form.Group>
                    ...
                    <Form.Control type="password" id="current-password" onChange={onUserPasswordChangeHandler}/>
                ...
                <Col sm={4}>
                  <Form.Group>
                    ...
                    required
                      ...
                      onChange={(event) => onRoleChangeHandler(event.target.value)}
              ...
              <Row>
                <Col sm={12} className="asterix-caption">indicates required fields</Col>
                </Row>
                <Row>&nbsp;</Row>
                <Row className="justify-content-md-right">
                <Col sm={10}  className="float-right">
                  <Button type="submit" onClick={onSubmitHandler} variant="primary" size="lg" className="float-right" >
                    Submit
                  </Button>
                </Col>
              </Row>
